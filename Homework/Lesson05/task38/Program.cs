...
// Создать массив вещественнных чисел заданного размера (метод)
// Заполнить массив из консоли (метод)
// Вывести массив в консоль (метод)
// Определить разницу между максимальным и минимальным элементом массива
